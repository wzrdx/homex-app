...
export const getEnvValue = (devValue, prodValue) => (process.env.NODE_ENV === 'development' ? devValue : prodValue);
...
export const TEAM = [
    ...
    'erd1e2u4wl543wguajr5ptdztgygx4lnd9mm30ywjkkutrt922f27upsk6a5qq',
];
