...
export const TOKEN_ID = 'HOLYCOWS-90e467';
...
// export const START_OF_CONTEST = new Date('2023-06-01T12:00:00.000Z');
export const START_OF_CONTEST = new Date('2023-05-29T12:30:15.000Z');
