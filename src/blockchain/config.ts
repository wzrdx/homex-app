export const TEAM = ['erd1za7d0lzgnee39p9sytre0mss76tnht70fem0pcv0zn4undcfukrqqkzcpl'];
...
export type Config = {
    ...
    mazeDenomination: number;
    energyQueryingInterval: number;
    mazeQueryingInterval: number;
    team: string[];
};

// TODO: Big numbers, isEmpty(window.localStorage.api)
export const config: Config = {
    ...
    mazeDenomination: 1000000000000000000,
