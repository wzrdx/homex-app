...
const getFLIPiXPrize = (amount: number = 0) => ({
    backgroundColor: '#2b2d31',
    imageSrc: getFLIPiXLogo(),
    height: { md: '36px', lg: '48px' },
    textColor: 'flipix',
    text: `${amount} Points`,
});
...
export const RAFFLES: any[] = getEnvValue(
    [
        {
        ...
        },
        {
            type: RewardType.Prizes,
            id: getId(),
            prizes: [getFLIPiXPrize(20), getEssencePrize(500)],
            winners: 1,
        ...
        },
        {
            type: RewardType.Prizes,
            id: getId(),
            prizes: [getFLIPiXPrize(15), getEssencePrize(500)],
            winners: 1,
            eligibilityRequired: true,
        },
        {
            type: RewardType.Prizes,
            id: getId(),
            prizes: [getFLIPiXPrize(10), getEssencePrize(500)],
            winners: 1,
            eligibilityRequired: true,
        },
    ],
